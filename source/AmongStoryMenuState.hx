	...
	override function create()
	{
		...
		switch(curSection){
			...
			case 1:
				for (i in 0...4)
				{
					if(i == 0) WeekData.setDirectoryFromWeek(WeekData.weeksLoaded.get(WeekData.weeksList[i]));
					else WeekData.setDirectoryFromWeek(WeekData.weeksLoaded.get(WeekData.weeksList[i + 4]));
