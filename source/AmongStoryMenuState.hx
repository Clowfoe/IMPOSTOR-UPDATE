...
class AmongStoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		txtWeekTitle = new FlxText(FlxG.width / 2.5, txtWeekNumber.y + 100, 0, "");
