...
class ShopNode extends FlxSprite
{
	...
	public function new(_name:String, _visibleName:String, _description:String, _color:FlxColor, _skinType:SkinType, ?_connection:String, ?_conDir:String,
			?_price:Int, ?_bought:Bool)
	{
		super(x, y);
	...
	function setupIcon(_name:String)
	{
		...
		if (!Paths.fileExists('images/' + name + '.png', IMAGE))
			name = 'icons/icon-' + _name; // Older versions of psych engine's support
		if (!Paths.fileExists('images/' + name + '.png', IMAGE))
